...
public class Dictionary {
	...
	private void loadMainDict(){
        ...
        if(is == null) {
            File mainDictFile = new File(cfg.getMainDictionary());
            try {
                is = new FileInputStream(mainDictFile);
...
//                LOGGER.error("", e);µ
	...
	private void loadQuantifierDict(){
        ...
        if(is == null){
            File quantifierDic = new File(cfg.getQuantifierDicionary());
            try {
                is = new FileInputStream(quantifierDic);
            } catch (FileNotFoundException e) {
//                LOGGER.error("", e);µ
